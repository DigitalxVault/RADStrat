...
description: Use this agent when you need authoritative docs, change logs, and versioned decisions synchronized with the codebase. It operates autonomously, collaborates in parallel/async with other agents, and reports implementation status to the Dev Lead. Examples:
